...
impl BroadcastData {
    pub(crate) fn from_message(message: &Message) -> Result<Self> {
        if message.message_type() != MessageType::Keygen(KeygenMessageType::Broadcast(BroadcastMessageType::Disperse)) && message.message_type() != MessageType::Keygen(KeygenMessageType::Broadcast(BroadcastMessageType::ReDisperse)) {
